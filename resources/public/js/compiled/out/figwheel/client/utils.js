...
var or__40050__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj46640 = {"detail":data};
return obj46640;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__40038__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__40038__auto__)){
var and__40038__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__46647 = cljs.core._EQ_;
var expr__46648 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46647.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46648))){
return ((function (pred__46647,expr__46648){
return (function (p1__46641_SHARP_){
return console.warn(p1__46641_SHARP_);
});
;})(pred__46647,expr__46648))
} else {
if(cljs.core.truth_(pred__46647.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46648))){
return ((function (pred__46647,expr__46648){
return (function (p1__46642_SHARP_){
return console.debug(p1__46642_SHARP_);
});
;})(pred__46647,expr__46648))
} else {
if(cljs.core.truth_(pred__46647.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46648))){
return ((function (pred__46647,expr__46648){
return (function (p1__46643_SHARP_){
return console.error(p1__46643_SHARP_);
});
;})(pred__46647,expr__46648))
} else {
return ((function (pred__46647,expr__46648){
return (function (p1__46644_SHARP_){
return console.log(p1__46644_SHARP_);
});
;})(pred__46647,expr__46648))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46651){
...
var opts = map__46652__$1;
var eval_fn = cljs.core.get.call(null,map__46652__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__46654_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__46656,(0),null);
var v = cljs.core.nth.call(null,vec__46656,(1),null);
...
if(cljs.core.truth_((function (){var and__40038__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1501581652734
