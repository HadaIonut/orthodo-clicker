...
var G__46336 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46336;
continue;
} else {
return ch;
...
var vec__46337 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__46337,(0),null);
return (match === s);
});
...
var len__41214__auto___46342 = arguments.length;
var i__41215__auto___46343 = (0);
while(true){
if((i__41215__auto___46343 < len__41214__auto___46342)){
args__41221__auto__.push((arguments[i__41215__auto___46343]));

var G__46344 = (i__41215__auto___46343 + (1));
i__41215__auto___46343 = G__46344;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__41222__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46340){
var G__46341 = cljs.core.first.call(null,seq46340);
var seq46340__$1 = cljs.core.next.call(null,seq46340);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__46341,seq46340__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46345__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__46345 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46346__i = 0, G__46346__a = new Array(arguments.length -  1);
while (G__46346__i < G__46346__a.length) {G__46346__a[G__46346__i] = arguments[G__46346__i + 1]; ++G__46346__i;}
  _ = new cljs.core.IndexedSeq(G__46346__a,0,null);
} 
return G__46345__delegate.call(this,rdr,_);};
G__46345.cljs$lang$maxFixedArity = 1;
G__46345.cljs$lang$applyTo = (function (arglist__46347){
var rdr = cljs.core.first(arglist__46347);
var _ = cljs.core.rest(arglist__46347);
return G__46345__delegate(rdr,_);
});
G__46345.cljs$core$IFn$_invoke$arity$variadic = G__46345__delegate;
return G__46345;
})()
;
});

//# sourceMappingURL=commons.js.map?rel=1501581649854
