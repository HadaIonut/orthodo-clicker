...
var and__40038__auto__ = !(("#" === ch));
if(and__40038__auto__){
var and__40038__auto____$1 = !(("'" === ch));
if(and__40038__auto____$1){
var and__40038__auto____$2 = !((":" === ch));
...
if(cljs.core.truth_((function (){var and__40038__auto__ = validate_leading_QMARK_;
...
var G__46486 = (function (){var G__46484 = sb;
G__46484.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__46484;
})();
var G__46487 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__46486;
ch = G__46487;
continue;
}
...
var temp__4655__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__46488 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46488,ch);
...
var or__40050__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var vec__46496 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46496,(0),null);
var start_column = cljs.core.nth.call(null,vec__46496,(1),null);
...
var G__46500 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__46500;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__46499 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46499,ch);

return G__46499;
})(),true,null,opts);
var G__46501 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__46501;
continue;
}
}
...
var vec__46502 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46502,(0),null);
var start_column = cljs.core.nth.call(null,vec__46502,(1),null);
...
var sb = (function (){var G__46505 = (new goog.string.StringBuffer());
G__46505.append(initch);
...
var G__46507 = (function (){var G__46506 = sb;
G__46506.append(ch);

return G__46506;
})();
var G__46508 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46507;
ch = G__46508;
continue;
}
...
while(true){
var G__46511 = ch;
if(cljs.core._EQ_.call(null,null,G__46511)){
...
if(cljs.core._EQ_.call(null,"\\",G__46511)){
var G__46514 = (function (){var G__46512 = sb;
G__46512.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__46512;
})();
var G__46515 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46514;
ch = G__46515;
continue;
} else {
...
var G__46516 = (function (){var G__46513 = sb;
G__46513.append(ch);

return G__46513;
})();
var G__46517 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46516;
ch = G__46517;
continue;
...
break;
default:
var or__40050__auto__ = (function (){var temp__4657__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
...
return cljs.core._conj.call(null,(function (){var x__40907__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
...
var G__46521 = rdr;
cljs.tools.reader.edn.read.call(null,G__46521,true,null,true);
...
var temp__4655__auto__ = (function (){var G__46522 = token;
var G__46522__$1 = (((G__46522 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46522));
if((G__46522__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46522__$1);
}
})();
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__40050__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",-2118263030).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__40050__auto__)){
return or__40050__auto__;
} else {
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46529,reader){
...
var eof = cljs.core.get.call(null,map__46530__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e46532){if((e46532 instanceof Error)){
var e = e46532;
...
//# sourceMappingURL=edn.js.map?rel=1501581652137
